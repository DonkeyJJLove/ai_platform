...
Przypadki w [evolution_cases.yaml](evolution_cases.yaml) oceniają reasonera i proces, nie samo istnienie słów w dokumentacji. YAML zapisano w kompatybilnej składni JSON (podzbiór YAML 1.2).
