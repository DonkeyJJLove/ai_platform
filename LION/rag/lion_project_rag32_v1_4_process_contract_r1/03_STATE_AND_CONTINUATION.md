...
```text
process_contract_schema=lion.phase-execution-contract/v1
process_contract_digest=429d82a2233c3eae6b4475dbe3e99edf7760598bf2010d94636bd075b2936854
compiler_version=lion.phase-contract-compiler/1.0
unresolved_phase_contract_count=UNKNOWN_REQUIRES_LIVE_READBACK
unbound_capability_contract_count=UNKNOWN_REQUIRES_LIVE_READBACK
```

Dla procesu zależnego od fazy odczytaj `33_LION_PROCESS_CONTRACT_PLANE__v1_4_process_contract_r1.md`, a następnie reacquire live Mission Control preflight/bindings. Pakiet RAG nie może sam wyliczyć bieżącej liczby unresolved/unbound kontraktów.
...
```json
{
  ...
  "required_read_sets": {
    ...
    "process_contract": [
      ...
      "02_ROUTING_AND_SOURCE_MAP.md",
      "33_LION_PROCESS_CONTRACT_PLANE__v1_4_process_contract_r1.md",
      "32_CODEX_PROJECT_INTEGRATION.md"
    ]
  }
}
```
