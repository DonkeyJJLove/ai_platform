...
def _absent(
    observed_at: str,
    observer_id: str = "moon-host-file-observer-v1",
    *,
    base_device: int = 11,
    base_inode: int = 22,
) -> MoonFileTargetObservation:
...
class MoonFileWriteCurrentnessTests(unittest.TestCase):
    ...
    def test_base_device_change_changes_state_digest(self):
        first = _absent("2026-08-27T07:13:10+00:00", base_device=11)
        second = _absent("2026-08-27T07:13:11+00:00", base_device=12)
        self.assertNotEqual(first.state_digest(), second.state_digest())

    def test_base_inode_change_changes_state_digest(self):
        first = _absent("2026-08-27T07:13:10+00:00", base_inode=22)
        second = _absent("2026-08-27T07:13:11+00:00", base_inode=23)
        self.assertNotEqual(first.state_digest(), second.state_digest())
