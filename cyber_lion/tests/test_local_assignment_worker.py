    ...
    def test_conversation_message_is_not_duplicated_into_operator_guidance(self):
        ...
        def control(op,args):
            ...
            if op=="local_assignment_receipt":
                receipt_result.update(args["result"])
                return {"receipt_id":"conversation-receipt","duplicate":False}
            raise AssertionError(op)
        ...
        self.assertEqual(receipt_result["operator_message_ids"],["m1"])
