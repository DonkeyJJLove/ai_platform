...
def adm(r): return CanonicalIssueCommentWriteAdmission(r.request_digest,r.repository,r.issue_number,r.action,r.semantic_capability,body_digest(r.body),r.expected_repository_head,"2"*64,"3"*64,1,7,"test-provider").sealed()
class Resolver:
