...
SOURCE_MAP = {
    ...
    "lion_direct_supervisor_bridge.py": ROOT / "tools/lion_direct_supervisor_bridge.py",
    ...
    "systemd/lion-direct-supervisor-bridge.service": ROOT / "deploy/systemd/lion-direct-supervisor-bridge.service",
