...
def canonical_gap_projection() -> tuple[GapRecord, ...]:
    ...
    The function name deliberately avoids treating every record as a target.  The
    compatibility alias ``canonical_target_gaps`` is retained for existing renderers.
    """
    return (
