...
_ELEMENT_SPECS = (
    ...
    ("cognitive-invocation", "EVOLUTIONARY_EPOCH", "Cognitive invocation domain", "IMPLEMENTED", "cyber_lion/contracts/cognitive_invocation.py", "CognitiveProvider", "LIVE_CODE"),
    ("evidence-bound-learning", "EVIDENCE_AND_EPISTEMIC_PLANE", "Evidence-bound learning episode", "IMPLEMENTED", "cyber_lion/contracts/evidence_bound_learning_episode.py", "EvidenceBoundLearningEpisode", "LIVE_CODE"),
    ("coordinator-competency", "EVIDENCE_AND_EPISTEMIC_PLANE", "Coordinator competency evidence", "IMPLEMENTED", "cyber_lion/contracts/coordinator_competency.py", "CoordinatorCompetencyProfile", "LIVE_CODE"),
    ...
    ("model-call-v2", "FLEET_AND_SWARM", "Model call v2 provenance", "IMPLEMENTED", "cyber_lion/contracts/model_call_v2.py", "ModelCallV2", "LIVE_CODE"),
    ...
    ("model-release", "TRUSTED_RUNTIME", "Immutable model release identity", "IMPLEMENTED", "cyber_lion/contracts/model_release.py", "ModelRelease", "LIVE_CODE"),
)
