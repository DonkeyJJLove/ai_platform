...
let history=[];let lastQuestion='';let lastAnswer='';let lastPayload=null;let activeThreadId=null;let threads=[];let missions=[];let selectedMissionId=null;let missionData=null;let protoFilter='ALL';let lpclValidated=null;let lpclRegistered=null;let pendingSaasPolls=new Map();
