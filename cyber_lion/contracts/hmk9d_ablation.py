...
class HMK9DMatchedAblation:
    corpus_digest:str;model_release_ref:str;prompt_profile_digest:str;tool_schema_digest:str;runtime_digest:str;hmk9d_annotation_source_ref:str;variant_a_annotation:bool;variant_b_annotation:bool;authority_effect:str="NONE";training_effect:str="NONE"
    def validate(self):
        ...
        if not self.model_release_ref or not self.hmk9d_annotation_source_ref:raise HMK9DAblationError("identity")
